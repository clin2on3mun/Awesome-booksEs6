...
**[Awesome Books with ES6]** is a project that uses ES6 syntax and modules to stores the book dynamically and view books stored in localStorage in browser on UI.
...
Clone this repository to your desired folder:
  ...
  cd my-folder
  git clone git@github.com:clin2on3mun/Awesome-booksEs6.git
